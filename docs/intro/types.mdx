...
yolkbot has (almost) full Typescript support! This means that you can use yolkbot in a Typescript project and get full type checking and intellisense. IDEs like VSCode will support yolkbot's types and autocomplete things, making it easier to write code.
...
- `yolkbot/comm` (partially documented)
- `yolkbot/pathing`
