---
title: "Using Tests"
description: "yolkbot uses tests to make sure the codebase works. You can, too."
---
...
Tests are SUPER great for beginners since they provide really nice examples that are broken down and easy to read/figure out.