...
The gun class has a lot of information about each gun, which is better gleamed by just...[reading the code...](https://github.com/yolkorg/yolkbot/blob/main/src/constants/guns.js)
...
Items are a large thing I don't want to document. I'm documenting yolkbot, not shell. [Read the code.](https://github.com/yolkorg/yolkbot/blob/main/src/constants/items.js)
...
I'm not documenting the Map object either. It's briefly covered when discussing the Matchmaker in the [Bot](../bot/bot) guide. [Read the code.](https://github.com/yolkorg/yolkbot/blob/main/src/constants/maps.js)
