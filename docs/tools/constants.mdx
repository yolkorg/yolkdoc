...
I'm not documenting the Map object either. It's briefly covered when discussing the Matchmaker in the [Bot](../bot/bot) guide. [Read the code.](https://github.com/enbyte/yolkbot/blob/main/src/constants/maps.js)
